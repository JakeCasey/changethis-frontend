...
const Table = external_styled_components_default.a.table.withConfig({
  displayName: "Table",
  componentId: "sc-1fe4y8d-0"
})(["border-spacing:0;width:100%;box-shadow:", ";border-radius:", ";thead{color:#8D8D8D;font-size:10px;background-color:#F1F1F1;}td,th{padding:12px;border-bottom:1px solid ", ";position:relative;&:last-child{border-right:none;width:150px;button{width:100%;}}label{padding:10px 5px;display:block;}}tr{}"], props => props.theme.bs, props => props.theme.borders, props => props.theme.offWhite);
...
const UPDATE_PERMISSIONS_MUTATION = external_graphql_tag_default.a`
...
`;
const ALL_USERS_QUERY = external_graphql_tag_default.a`
  query {
    users {
      id
      name
...
const Permissions = props => external_react_default.a.createElement(external_react_apollo_["Query"], {
  ...
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement("div", null, external_react_default.a.createElement("h2", null, "Manage Permissions"), external_react_default.a.createElement(styles_Table, null, external_react_default.a.createElement("thead", null, external_react_default.a.createElement("tr", null, external_react_default.a.createElement("th", null, "Name"), external_react_default.a.createElement("th", null, "Email"), possiblePermissions.map(permission => external_react_default.a.createElement("th", {
    key: permission
  }, permission)), external_react_default.a.createElement("th", null, "\uD83D\uDC47"))), external_react_default.a.createElement("tbody", null, data.users.map(user => external_react_default.a.createElement(Permissions_UserPermissions, {
    key: user.id,
    user: user
  }))))));
});

class Permissions_UserPermissions extends external_react_default.a.Component {
  constructor(...args) {
    super(...args);
    ...
    Object(defineProperty["a" /* default */])(this, "handlePermissionChange", (e, updatePermissions) => {
  ...
  render() {
    ...
    return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
      ...
      loading,
      error
    }) => external_react_default.a.createElement(external_react_default.a.Fragment, null, error && external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
      colspan: "8"
    }, external_react_default.a.createElement(ErrorMessage["a" /* default */], {
      error: error
    }))), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", null, user.name), external_react_default.a.createElement("td", null, user.email), possiblePermissions.map(p => external_react_default.a.createElement("td", {
      key: p
...
/* harmony default export */ var components_Permissions = (Permissions);
// CONCATENATED MODULE: ./pages/permissions.js




const PermissionsPage = props => external_react_default.a.createElement("div", null, external_react_default.a.createElement(PleaseSignIn["a" /* default */], null, external_react_default.a.createElement(components_Permissions, null)));

/* harmony default export */ var permissions = __webpack_exports__["default"] = (PermissionsPage);
