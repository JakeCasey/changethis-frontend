...
// CONCATENATED MODULE: ./components/wrappers/GetPlansList.js




const GET_PLANS_LIST_QUERY = external_graphql_tag_default.a`
  query {
   getPlansList {
     id
     planId
...
const GetPlansList = props => {
  return external_react_default.a.createElement(external_react_apollo_["Query"], Object(esm_extends["a" /* default */])({}, props, {
    query: GET_PLANS_LIST_QUERY
  }), payload => props.children(payload));
};

/* harmony default export */ var wrappers_GetPlansList = (GetPlansList);
...
const SUBSCRIBE_USER_MUTATION = external_graphql_tag_default.a`
...
class Subscribe_Subscribe extends external_react_default.a.Component {
  constructor(...args) {
    ...
    Object(defineProperty["a" /* default */])(this, "onToken", async (token, planId, subscribe) => {
      var {
        id
      } = token;
  ...
  render() {
    ...
    return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
      ...
      loading,
      error
    }) => external_react_default.a.createElement("div", null, external_react_default.a.createElement("h2", null, planId), external_react_default.a.createElement(external_react_stripe_checkout_default.a, {
      name: planId,
      description: description,
      token: token => this.onToken(token, planId, subscribe),
      stripeKey: config["a" /* STRIPE_PUBLIC_KEY */]
...
// CONCATENATED MODULE: ./components/Unsubscribe.js
...
const UNSUBSCRIBE_USER_MUTATION = external_graphql_tag_default.a`
...
`;
class Unsubscribe_Unsubscribe extends external_react_default.a.Component {
  constructor(...args) {
    super(...args);

    Object(defineProperty["a" /* default */])(this, "onClick", async (planId, unsubscribe) => {
  ...
  render() {
    ...
    return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
      ...
      loading,
      error
    }) => external_react_default.a.createElement("div", null, external_react_default.a.createElement("h2", null, planId), external_react_default.a.createElement(SickButton["a" /* default */], {
      disabled: loading,
...
// CONCATENATED MODULE: ./components/SubscribeOrUnsubscribe.js
...
const SubscribeOrUnsubscribe = ({
  ...
  return external_react_default.a.createElement(User["b" /* default */], null, ({
    data: {
      me
    },
    error
  }) => {
    return external_react_default.a.createElement("div", null, isSubscribedToThisPlan(me.plansSubscribed, plan) ? external_react_default.a.createElement(Unsubscribe_Unsubscribe, {
      plan: plan
...
/* harmony default export */ var components_SubscribeOrUnsubscribe = (SubscribeOrUnsubscribe);
...
const Plans = props => {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(wrappers_GetPlansList, null, ({
    data: {
      getPlansList
    },
    error
    ...
    return external_react_default.a.createElement("div", null, external_react_default.a.createElement("h1", null, " Our Plans "), getPlansList.map((p, i) => external_react_default.a.createElement(components_SubscribeOrUnsubscribe, {
      key: i,
      plan: p
    })));
  }));
...
/* harmony default export */ var components_Plans = (Plans);
// CONCATENATED MODULE: ./pages/plans.js




const PermissionsPage = props => external_react_default.a.createElement("div", null, external_react_default.a.createElement(PleaseSignIn["a" /* default */], null, external_react_default.a.createElement(components_Plans, null)));

/* harmony default export */ var plans = __webpack_exports__["default"] = (PermissionsPage);
...
module.exports = __webpack_require__("+/GB");
