...
class ToolbarOverlay_ToolbarOverlay extends external_react_["Component"] {
  render() {
    return external_react_default.a.createElement("div", null, this.props.globalState && external_react_default.a.createElement(external_react_spring_["Transition"], {
...
class PinBlock_PinBlock extends external_react_["Component"] {
  ...
  render() {
    var block = this.props.block;
    return external_react_default.a.createElement(external_react_default.a.Fragment, null, this.props.globalState && this.props.globalState.state.pins.map((p, index) => {
...
class Toolbar_Toolbar extends external_react_["Component"] {
  constructor(...args) {
    ...
    Object(defineProperty["a" /* default */])(this, "showBlocks", () => {
      ...
      this.props.globalState.putComponentInToolbar(external_react_default.a.createElement(special_BlockList, null)); //open toolbar
  ...
  render() {
    ...
    return external_react_default.a.createElement(ToolbarDiv, null, this.props.globalState && this.props.globalState.state.toolbar.map((block, i) => {
      var type = block.type;
    ...
    }), this.props.globalState && external_react_default.a.createElement(external_react_clipboard_js_default.a, {
      component: SickButton["a" /* default */],
      "data-clipboard-text": external_btoa_default()(stringify_default()(this.props.globalState.state))
...
class Reporting_Reporting extends external_react_["Component"] {
  constructor(...args) {
    ...
    Object(defineProperty["a" /* default */])(this, "reloadIframe", () => {
      ...
      this.props.globalState.setCurrentIframe(urlString); // }
  ...
  render() {
    ...
    }, "Go")), external_react_default.a.createElement(WorkArea, null, external_react_default.a.createElement(Reporting_CanvasContainer, null, this.props.globalState && this.props.globalState.state.overIframe.map((OverIframe, i) => {
    ...
    }), ' ', this.props.globalState && this.props.globalState.state && external_react_default.a.createElement(Frame, {
      id: "iframe",
